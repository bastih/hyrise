...
class LoadOp : public PlanOperation {
 public:
...
class InsertOp : public PlanOperation {
 public:
  const std::string vname();
...
class UpdateOp : public PlanOperation {
 public:
  const std::string vname();
...
class ValidPositionsRawOp : public PlanOperation {
 public:
  const std::string vname();
...
class ValidPositionsMainOp : public PlanOperation {
 public:
  const std::string vname();
...
class ExtractDelta: public PlanOperation {
 public:
